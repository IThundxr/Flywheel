...
public enum GlBufferType {
	...
	PIXEL_PACK_BUFFER(GlConst.GL_PIXEL_PACK_BUFFER, GL21.GL_PIXEL_PACK_BUFFER_BINDING),
	PIXEL_UNPACK_BUFFER(GlConst.GL_PIXEL_UNPACK_BUFFER, GL21.GL_PIXEL_UNPACK_BUFFER_BINDING),
	TRANSFORM_FEEDBACK_BUFFER(GL30.GL_TRANSFORM_FEEDBACK_BUFFER, GL30.GL_TRANSFORM_FEEDBACK_BUFFER_BINDING),
	UNIFORM_BUFFER(GlConst.GL_UNIFORM_BUFFER, GL31.GL_UNIFORM_BUFFER_BINDING),
	TEXTURE_BUFFER(GL31.GL_TEXTURE_BUFFER, GL31.GL_TEXTURE_BUFFER),
	COPY_READ_BUFFER(GlConst.GL_COPY_READ_BUFFER, GlConst.GL_COPY_READ_BUFFER),
	COPY_WRITE_BUFFER(GlConst.GL_COPY_WRITE_BUFFER, GlConst.GL_COPY_WRITE_BUFFER),
	...
	public static GlBufferType fromTarget(int pTarget) {
		return switch (pTarget) {
			case GlConst.GL_ARRAY_BUFFER -> ARRAY_BUFFER;
			case GlConst.GL_ELEMENT_ARRAY_BUFFER -> ELEMENT_ARRAY_BUFFER;
			case GlConst.GL_PIXEL_PACK_BUFFER -> PIXEL_PACK_BUFFER;
			case GlConst.GL_PIXEL_UNPACK_BUFFER -> PIXEL_UNPACK_BUFFER;
			case GL30.GL_TRANSFORM_FEEDBACK_BUFFER -> TRANSFORM_FEEDBACK_BUFFER;
			case GlConst.GL_UNIFORM_BUFFER -> UNIFORM_BUFFER;
			case GL31.GL_TEXTURE_BUFFER -> TEXTURE_BUFFER;
			case GlConst.GL_COPY_READ_BUFFER -> COPY_READ_BUFFER;
			case GlConst.GL_COPY_WRITE_BUFFER -> COPY_WRITE_BUFFER;
