...
public class VulkanRenderPipelineMixin {
	...
	private static VkPipelineLayoutCreateInfo flywheel$addPushConstantsSupport(VkPipelineLayoutCreateInfo original, @Local(name = "stack") MemoryStack stack) {
		...
		return original.pPushConstantRanges(pushConstants);
	}
}
