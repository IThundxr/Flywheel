...
const uint _FLW_USE_OIT_LENGTH = 1u;
...
const uint _FLW_USE_OVERLAY_OFFSET = _FLW_BACKFACE_CULLING_OFFSET + _FLW_BACKFACE_CULLING_LENGTH;
const uint _FLW_USE_OIT_OFFSET = _FLW_USE_OVERLAY_OFFSET + _FLW_USE_OVERLAY_LENGTH;
const uint _FLW_USE_LIGHT_OFFSET = _FLW_USE_OIT_OFFSET + _FLW_USE_OIT_LENGTH;
...
const uint _FLW_USE_OIT_MASK = ((1u << _FLW_USE_OIT_LENGTH) - 1u) << _FLW_USE_OIT_OFFSET;
...
//    m.writeMask = (p & _FLW_WRITE_MASK_MASK) >> _FLW_WRITE_MASK_OFFSET;
    ...
    m.useOit = (p & _FLW_USE_OIT_MASK) != 0u;
