...
subproject.init("flywheel-fabric-without-frapi", "flywheel_group", "flywheel_version")
...
jarSets {
    mainSet.publishWithRawSources {
        artifactId = "flywheel-fabric-without-frapi-${property("artifact_minecraft_version")}"
    }
    ...
    create("api", api, lib).apply {
        ...
        publishWithRawSources {
            artifactId = "flywheel-fabric-without-frapi-api-${property("artifact_minecraft_version")}"
        }
    }
}
